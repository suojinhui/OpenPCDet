...
def show_image_with_boxes(img, objects, calib, show3d=True):
    ...
    if show3d:
        Image.fromarray(img2).save('output/vis_results/image_with_3Dboxes.png')
        # Image.fromarray(img2).show()
    else:
        Image.fromarray(img1).save('output/vis_results/image_with_2Dboxes.png')
...
def show_lidar_topview(pc_velo, objects, calib):
    ...
    im2.save('output/vis_results/BEV.png')
    # im2.show()
...
def show_lidar_topview_with_boxes(img, objects, calib):
    ...
    im2.save('output/vis_results/BEV with boxes.png')
    # im2.show()
...
def show_lidar_on_image(pc_velo, img, calib, img_width, img_height):
    ...
    Image.fromarray(img).save('output/vis_results/lidar_on_image.png')
...
def get_lidar_in_image_fov(pc_velo, calib, xmin, ymin, xmax, ymax,
    ...
    fov_inds = fov_inds & (pc_velo[:,0]>clip_distance) # 选择车前面的点云
